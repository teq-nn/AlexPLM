...
!!! note "Was geprüft wird — und was nicht"
...
!!! tip "Lokales Arbeiten braucht kein Konto"
...
!!! note "Warum hier Git-nähere Worte erlaubt sind"
...
[manuellen Sync](../konzepte/mehrbenutzer.md#manueller-sync-sichern-holen):
...
Das vollständige Modell steht unter [Mehrbenutzer & Sync](../konzepte/mehrbenutzer.md).

!!! warning "Server ist im Team Pflicht"
