...
|---|---|---|
| <span class="led led-frei"></span> **Grün — frei** | niemand bearbeitet die Datei; sie liegt schreibgeschützt (read-only) auf der Platte | du kannst sie übernehmen, indem du sie bearbeitest |
| <span class="led led-arbeit"></span> **Grau — in Arbeit / ruhend** | normaler Arbeitszustand bzw. von dir in Bearbeitung | alles in Ordnung, keine Aktion nötig |
| <span class="led led-achtung"></span> **Orange — fremd gesperrt** | ein:e Kolleg:in bearbeitet diese Binärdatei gerade | nicht gleichzeitig anfassen; Tooltip zeigt „gesperrt von X seit …" |

!!! note "Read-only ist Absicht"
...
| LED | Bedeutung |
|---|---|
| <span class="led led-frei"></span> **Grün** | abgeschlossen / freigegeben / frisch angelegt (der „fertig"-Zustand) |
| <span class="led led-arbeit"></span> **Grau** | ruhend / gesichert / in Arbeit (der ruhige Alltag) |

## Der Sync-Status in Worten

Neben den Punkten meldet das Werkzeug den Abgleich in Worten (siehe
[Mehrbenutzer & Sync](../konzepte/mehrbenutzer.md)):
