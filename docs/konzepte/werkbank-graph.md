...
(aus dem [Baustein](bausteine.md)) erkannt hat:
...
- den **Status-LED** oben links (frei / in Arbeit / fremd gesperrt — siehe
  [Status-LEDs](../referenz/status-leds.md)),
...
Sperre (siehe [Mehrbenutzer & Sync](mehrbenutzer.md)).
...
!!! note "Der Status wird gelesen, nicht gespeichert"
...
steht unter [Versionen & Meilensteine](versionen.md).
