...
(ein *Prototyp* — siehe [Versionen & Meilensteine](Versionen-und-Meilensteine)).
...
- **Blatt-Ordner** (ohne Unterordner mit eigenen Regeln) tragen einen [Baustein](Bausteine-und-Werkzeugkasten)
...
> **💡 „Module" sind einfach Gruppen-Ordner**
>
...
du mit ihnen arbeitest, steht unter [Werkbank & Graph-Raum](Werkbank-und-Graph-Raum).
